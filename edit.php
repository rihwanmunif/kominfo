<?php
    ...
    $hasil = $proses->tampil_data_id('users','id',$idGet);
?>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<div class="card">
						...
						<h4 class="card-title">Edit Pengguna - <?php echo $hasil['username'];?></h4>
						</div>
						<div class="card-body">
						...
						dengan method post ke proses crud dengan paramater get aksi edit -->
							<form action="proses/crud.php?aksi=edit" method="POST">
								<div class="form-group">
									...
									<input type="text" value="<?php echo $hasil['username'];?>" class="form-control" name="nama" required>
								</div>
								<div class="form-group">
									<label>Email</label>
									<input type="email" value="<?php echo $hasil['email'];?>" class="form-control" name="email" required>
								</div>
								<div class="form-group">
